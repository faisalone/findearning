        ...
        <div class="container">
            <div class="rts-featured-product-section-inner">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="full-wrapper wrapper-2 wrapper-4">
                            <div class="image-part">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="full-wrapper wrapper-3 wrapper-4">
                            <div class="image-part">
                            ...
                            <div class="blog-content">
                                ...
                                <div class="title">
                                    <a href="#">At the limit, statically generated, edge delivered a food door to door</a>
                                </div>
                                <div class="author-info d-flex align-items-center">
                                    <div class="avatar"><img src="{{ asset('assets/images/featured/author.png') }}" alt="Author Image"></div>
                                    <div class="info">
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="full-wrapper wrapper-1 wrapper-4">
                            <div class="image-part">
                                <a href="#" class="image"><img src="{{ asset('assets/images/blog/img-1.jpg') }}" alt="Featured Image"></a>
                            </div>
                            <div class="blog-content">
                                <span class="date-full">
                                    <span class="day">25</span>
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="full-wrapper wrapper-2 wrapper-4">
                            <div class="image-part">
                                <a href="#" class="image"><img src="{{ asset('assets/images/blog/img-2.jpg') }}" alt="Featured Image"></a>
                            </div>
                            <div class="blog-content">
                                <span class="date-full">
                                    <span class="day">25</span>
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="full-wrapper wrapper-3 wrapper-4">
                            <div class="image-part">
                                <a href="#" class="image"><img src="{{ asset('assets/images/blog/img-3.jpg') }}" alt="Featured Image"></a>
                            </div>
                            <div class="blog-content">
                                <span class="date-full">
                                    <span class="day">25</span>
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="full-wrapper wrapper-1 wrapper-4">
                            <div class="image-part">
                                <a href="#" class="image"><img src="{{ asset('assets/images/featured/blog-4.jpg') }}" alt="Featured Image"></a>
                            </div>
                            <div class="blog-content">
                                <span class="date-full">
                                    <span class="day">25</span>
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="full-wrapper wrapper-2 wrapper-4">
                            <div class="image-part">
                                <a href="#" class="image"><img src="{{ asset('assets/images/featured/blog-5.jpg') }}" alt="Featured Image"></a>
                            </div>
                            <div class="blog-content">
                                <span class="date-full">
                                    <span class="day">25</span>
                    ...
                    <div class="col-xl-4 col-md-6 col-sm-12">
                        <div class="full-wrapper wrapper-3  wrapper-4">
                            <div class="image-part">
                                <a href="#" class="image"><img src="{{ asset('assets/images/featured/blog-6.jpg') }}" alt="Featured Image"></a>
                            </div>
                            <div class="blog-content">
                                <span class="date-full">
                                    <span class="day">25</span>
