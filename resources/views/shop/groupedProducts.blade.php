                        ...
                        <div class="product-thumb-area">
                            ...
                            <div class="thumb-wrapper one filterd-items figure">
                                <div class="product-thumb zoom" onmousemove="zoom(event)"
                                    style="background-image: url('{{ asset('assets/images/hand-picked/slider-img8_3.jpg') }}')"><img
                                        src="{{ asset('assets/images/hand-picked/slider-img8_3.jpg') }}" alt="product-thumb">
                                </div>
                            </div>
                            <div class="thumb-wrapper two filterd-items hide">
                                <div class="product-thumb zoom" onmousemove="zoom(event)"
                                    style="background-image: url('{{ asset('assets/images/hand-picked/woman-shirt-338x450.png') }}')"><img
                                        src="{{ asset('assets/images/hand-picked/woman-shirt-338x450.png') }}" alt="product-thumb">
                                </div>
                            </div>
                            <div class="thumb-wrapper three filterd-items hide">
                                <div class="product-thumb zoom" onmousemove="zoom(event)"
                                    style="background-image: url('{{ asset('assets/images/hand-picked/slider-img12-3.webp') }}')"><img
                                        src="{{ asset('assets/images/hand-picked/slider-img12-3.webp') }}" alt="product-thumb">
                                </div>
                            </div>
                            <div class="product-thumb-filter-group">
                                <div class="thumb-filter filter-btn active" data-show=".one"><img
                                        src="{{ asset('assets/images/hand-picked/slider-img8_3.jpg') }}" alt="product-thumb-filter"></div>
                                <div class="thumb-filter filter-btn" data-show=".two"><img
                                        src="{{ asset('assets/images/hand-picked/woman-shirt-338x450.png') }}" alt="product-thumb-filter"></div>
                                <div class="thumb-filter filter-btn" data-show=".three"><img
                                        src="{{ asset('assets/images/hand-picked/slider-img12-3.webp') }}" alt="product-thumb-filter"></div>
                            </div>
                        </div>
                        <div class="contents">
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text">
                                                <a href="{{ route('productDetails') }}">Women's Blouse</a>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text">
                                                <a href="{{ route('productDetails') }}">Women's Tshirt</a>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="price-text">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="text">
                                                <a href="{{ route('productDetails') }}">Girl's Top</a>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="price-text">
