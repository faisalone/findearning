...
@php
    ...
    $script= '<script src="' . asset('assets/js/vendors/zoom.js') . '"></script>
              <script src="' . asset('assets/partials/script.js') . '"></script>';
@endphp
                        ...
                        <div class="product-item element-item1">
                            ...
                            <div class="bottom-content">
                                ...
                                <div class="action-wrap">
                                    ...
                                    <a href="{{ route('cart') }}" class="addto-cart"><i class="fal fa-shopping-cart"></i> Add
                                        To
                                        Cart</a>
                                </div>
                            </div>
                        ...
                        <div class="product-thumb-area">
                            ...
                            <div class="thumb-wrapper one filterd-items figure">
                                <div class="product-thumb zoom" onmousemove="zoom(event)"
                                    style="background-image: url('{{ asset('assets/images/hand-picked/slider-img8_2.jpg') }}')"><img
                                        src="{{ asset('assets/images/hand-picked/slider-img8_2.jpg') }}" alt="product-thumb">
                                </div>
                            </div>
                            ...
                            <div class="product-thumb-filter-group">
                                <div class="thumb-filter filter-btn active" data-show=".one"><img
                                        src="{{ asset('assets/images/hand-picked/slider-img8_2.jpg') }}" alt="product-thumb-filter"></div>
                                <div class="thumb-filter filter-btn" data-show=".two"><img
                                        src="{{ asset('assets/images/hand-picked/woman-shirt-2.jpg') }}" alt="product-thumb-filter"></div>
