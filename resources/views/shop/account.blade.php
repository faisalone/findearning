            ...
            <div class="account-inner">
                <div class="account-side-navigation">
                    ...
                    <button class="filter-btn" data-show=".accountdtls"><i class="fal fa-user"></i> Account
                        Details</button>
                    <a href="{{ route('wishlist') }}" class="filter-btn" data-show=".dashboard"><i
                            class="fal fa-shopping-basket"></i>
                        Wishlist</a>
                    <a href="{{ route('login') }}" class="filter-btn" data-show=".dashboard"><i
                ...
                <div class="account-main-area">
                    <div class="account-main dashboard filterd-items">
                        <div class="account-profile-area">
                            <div class="profile-dp"><img src="{{ asset('assets/images/blog/img-13.jpg') }}" alt="profile-dp"></div>
                            <div class="d-block">
                        ...
                        <div class="activity-box">
                            ...
                            <a href="{{ route('login') }}" class="activity-item">
